 ...
 * Эмпатична 
 `,t.appendChild(e),t.appendChild(i);const o=document.createElement("div");o.className="block block-skills",o.appendChild(document.createElement("p")).innerText=`Навыки
 
 * Работа с UNIX системами, преимущественно c ArchLinux 
 * Git, Github Actions, Dokcer, Kubernrtes, Ansible, Nginx 
 * PostgreSQL, MySQL, MongoDB 
 * JS, Golang, Bash 
 * Понимание работы интернет протоколов и сетей`;const c=document.createElement("div");c.className="block block-ed",c.appendChild(document.createElement("p")).innerText=`Образование 
 ...
 Telegram: @shaitanyan`,a.appendChild(s),a.appendChild(t),a.appendChild(o),a.appendChild(c),a.appendChild(l),n.appendChild(a),document.body.appendChild(n)});
