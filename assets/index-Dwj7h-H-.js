 ...
 * Опыт работы с nginx, понимание работы сетевых протоколов`;const c=document.createElement("div");c.className="block block-ed",c.appendChild(document.createElement("p")).innerText=`Образование 
